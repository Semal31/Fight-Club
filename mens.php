...
require "Employee/includese/dbh.inc.php";
  ...
  $sql = "select id, name, type, description, price, stock from Items";
...
<div class="grid">
    <div class="i-items i-items1">
        <img src="/Pictures/Mens Shirt.jpg" class="img1" align="middle">
        <p>
    <?php
        $sql1 = "select id, name, type, description, price from Items WHERE id=1";
    ...
    <div class="i-items i-items2">
        <img src="/Pictures/Athletic Cup 2.jpg" class="img2">
        <p>
            <?php
        $sql1 = "select id, name, type, description, price from Items WHERE id=2";
        $result = $conn-> query($sql1);
        
        if ($result-> num_rows > 0) {
        while ($row = $result-> fetch_assoc()) {
             echo $row["description"];
             echo "<br><br><br> $", $row["price"];
            }  
          } ?>
        </p>
        <a href="/Order/form.php"><button>Order Now</button></a>
    ...
    <div class="i-items i-items1">
        <img src="/Pictures/Mens Shorts.webp" class="img3">
        <p>
            <?php
        $sql1 = "select id, name, type, description, price from Items WHERE id=3";
        $result = $conn-> query($sql1);
