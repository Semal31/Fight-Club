...
<div class="grid">
    <div class="i-items i-items1">
        <img src="/Pictures/Womens Shirt.jpg" class="img1" align="middle">
        <p>
    <?php
        $sql1 = "select id, name, type, description, price from Items WHERE id=7";
    ...
    <div class="i-items i-items2">
        <img src="/Pictures/Hairclip.jpeg" class="img2">
        <p>
            <?php
        $sql1 = "select id, name, type, description, price from Items WHERE id=9";
        $result = $conn-> query($sql1);
    ...
    <div class="i-items i-items1">
        <img src="/Pictures/Womens Shorts.jfif" class="img3">
        <p>
            <?php
        $sql1 = "select id, name, type, description, price from Items WHERE id=8";
        $result = $conn-> query($sql1);
